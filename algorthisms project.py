...
def main():
    ...
    for size in sizes:
        ...
        labels_no_pca, _ = run_dbscan(normalized_data, eps=2.5, min_samples=5)
        ...
        _, elapsed_time_no_pca = run_dbscan(normalized_data, eps=2.5, min_samples=5)
        ...
        labels_with_pca, _ = run_dbscan(reduced_data, eps=2.5, min_samples=5)
        ...
        # Run DBSCAN with PCA
        _, elapsed_time_with_pca = run_dbscan(reduced_data, eps=2.5, min_samples=5)
...
def main1():
    ...
    for size in sizes:
        ...
        # Run DBSCAN on normalized data without PCA
        labels_no_pca, _ = run_dbscan(normalized_data, eps=4.2, min_samples=5)
        ...
        # Run DBSCAN without PCA
        _, elapsed_time_no_pca = run_dbscan(normalized_data, eps=4.2, min_samples=5)
        times_no_pca.append(elapsed_time_no_pca)
        ...
        # Run DBSCAN on PCA-reduced data
        labels_with_pca, _ = run_dbscan(reduced_data, eps=4.2, min_samples=5)
        ...
        # Run DBSCAN with PCA
        _, elapsed_time_with_pca = run_dbscan(reduced_data, eps=4.2, min_samples=5)
        times_with_pca.append(elapsed_time_with_pca)
